...
namespace XPloit.Core.Helpers
{
    ...
    ///   </para>
    /// </summary>
    public static class BaseEncodingHelper
    {
        #region Helper
        ...
        public static byte[] FromBase16String(string inData)
        {
            return FromBase16CharArray(inData.ToCharArray(), 0, inData.Length);
        }
        ...
        /// <returns> Decoded data </returns>
        public static byte[] FromBase16CharArray(char[] inData, int offset, int length)
        {
        ...
        /// <returns> Decoded data </returns>
        public static byte[] FromBase32String(string inData)
        {
            return FromBase32CharArray(inData.ToCharArray(), 0, inData.Length);
        }
        ...
        /// <param name="length"> The number of elements of inData to decode. </param>
        /// <returns> Decoded data </returns>
        public static byte[] FromBase32CharArray(char[] inData, int offset, int length)
        {
            return FromBase32CharArray(inData, offset, length, _base32ReverseAlphabet);
        }
        ...
        {
            return ToBase32String(inArray, offset, length, _base32Alphabet);
        }
        ...
        /// <returns> Decoded data </returns>
        public static byte[] FromBase32HexString(string inData)
        {
            return FromBase32HexCharArray(inData.ToCharArray(), 0, inData.Length);
        }
        ...
        /// <param name="length"> The number of elements of inData to decode. </param>
        /// <returns> Decoded data </returns>
        public static byte[] FromBase32HexCharArray(char[] inData, int offset, int length)
        {
            return FromBase32CharArray(inData, offset, length, _base32HexReverseAlphabet);
        }
        ...
        /// <param name="inArray"> An array of 8-bit unsigned integers. </param>
        /// <returns> Encoded string </returns>
        public static string ToBase32HexString(byte[] inArray)
        {
            return ToBase32HexString(inArray, 0, inArray.Length);
        }
        ...
        /// <param name="length"> The number of elements of inArray to convert. </param>
        /// <returns> Encoded string </returns>
        public static string ToBase32HexString(byte[] inArray, int offset, int length)
        {
            return ToBase32String(inArray, offset, length, _base32HexAlphabet);
        }

        private static byte[] FromBase32CharArray(char[] inData, int offset, int length, Dictionary<char, byte> alphabet)
        {
            int paddingCount = 0;
        ...
        private static string ToBase32String(byte[] inArray, int offset, int length, char[] alphabet)
        {
        ...
        {
            return FromBase64CharArray(inData.ToCharArray(), 0, inData.Length);
        }
        ...
        /// <param name="length"> The number of elements of inData to decode. </param>
        /// <returns> Decoded data </returns>
        public static byte[] FromBase64CharArray(char[] inData, int offset, int length)
        {
            return FromBase64CharArray(inData, offset, length, _base64ReverseAlphabet);
        }
        ...
        {
            return ToBase64String(inArray, offset, length, _base64Alphabet);
        }
        ...
        /// <returns> Decoded data </returns>
        public static byte[] FromBase64UrlString(string inData)
        {
            return FromBase64UrlCharArray(inData.ToCharArray(), 0, inData.Length);
        }
        ...
        /// <param name="length"> The number of elements of inData to decode. </param>
        /// <returns> Decoded data </returns>
        public static byte[] FromBase64UrlCharArray(char[] inData, int offset, int length)
        {
            return FromBase64CharArray(inData, offset, length, _base64UrlReverseAlphabet);
        }
        ...
        {
            return ToBase64UrlString(inArray, 0, inArray.Length);
        }
        ...
        {
            return ToBase64String(inArray, offset, length, _base64UrlAlphabet);
        }

        private static byte[] FromBase64CharArray(char[] inData, int offset, int length, Dictionary<char, byte> alphabet)
        {
            int paddingCount;
            int remain;
        ...
        private static string ToBase64String(byte[] inArray, int offset, int length, char[] alphabet)
        {
