...
namespace XPloit.Core.Multi
{
    ...
    /// </summary>
    public class StreamSpeedLimit : Stream
    {
        /// <summary>
        ...
        public long MaximumBytesPerSecond
        {
            ...
            set { if (MaximumBytesPerSecond != value) { _maximumBytesPerSecond = value; Reset(); } }
        }
        ...
        public StreamSpeedLimit(Stream baseStream) : this(baseStream, StreamSpeedLimit.Infinite) { }
        ...
        public StreamSpeedLimit(Stream baseStream, long maximumBytesPerSecond)
        {
            if (baseStream == null)
            {
        ...
        public override int Read(byte[] buffer, int offset, int count)
        {
            ...
            try { return _baseStream.Read(buffer, offset, count); }
            catch { }
        ...
        public override void Write(byte[] buffer, int offset, int count)
        {
            ...
            try { _baseStream.Write(buffer, offset, count); }
            catch { }
        }
        ...
        /// </returns>
        public override string ToString() { return _baseStream.ToString(); }
        #endregion
        ...
        void Throttle(int bufferSizeInBytes)
        {
            // Make sure the buffer isn't empty.
            if (_maximumBytesPerSecond <= 0 || bufferSizeInBytes <= 0) return;
