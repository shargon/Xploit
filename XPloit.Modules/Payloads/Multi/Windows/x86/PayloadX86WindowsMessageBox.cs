...
namespace Payloads.Multi.Windows.x86
{
    public class PayloadX86WindowsMessageBox : Payload
    {
        ...
        #region Properties
        [ConfigurableProperty(Required = true, Description = "Message")]
        public string Message { get; set; }
        [ConfigurableProperty(Required = true, Description = "Exit technique: Seh, Process, Thread, None")]
        ...
        public override byte[] GetValue(Target mod)
        {
            ...
            byte[] shellcode2 = AsmHelper.StringToAsmX86(Message);
            //0x68, 
            ...
            return shellcode1.Concat(shellcode2).Concat(shellcode3).Concat(exit);
        }
    }
}